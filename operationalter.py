# -*- coding: utf-8 -*-
"""operationalter.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1H40Wkz0iwLVa_gNlwVJBM1ebO7-VdP_Q
"""
...
print("\nProbabilistic results only columns more than 5%\n")
df_prob.style.format(dict(zip(alg["pipe"].classes_ , np.full(len(alg["pipe"].classes_), '{:.0%}'))))
...
alg = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/skyc1_LEVX_1km_time_d0.al","rb"))
alg1 = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/skyc1_LEVX_1km_time_d1.al","rb"))
...
print("Reference (48 hours) Accuracy machine learning: 0.64")
...
alg = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/skyl1_LEVX_1km_time_d0.al","rb"))
alg1 = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/skyl1_LEVX_1km_time_d1.al","rb"))
...
print("Reference (48 hours) accuracy machine learning: 0.83\n")
print("Confusion matrix machine learning")
print(cm_ml)
...
#open algorithm temperature d0 d1
alg = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/pres_LEVX_1km_time_d0.al","rb"))
alg1 = pickle.load(open("/content/drive/MyDrive/Colab Notebooks/LEVX_1km/algorithms/pres_LEVX_1km_time_d1.al","rb"))
...
print("Reference (48 hours) Mean absolute error meteorological model: 0.85")
print("Reference (48 hours) Mean absolute error machine learning: 0.45\n")
